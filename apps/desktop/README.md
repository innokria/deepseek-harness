...
- Code signing, notarization, and the update feed are not configured.
- The app is registered in `tsconfig.host.json` and builds via the root `build:desktop` script; a dedicated packaging/CI job is a follow-up.
